...
emcmake cmake \
    ...
    -DCMAKE_EXE_LINKER_FLAGS="-sASSERTIONS -sERROR_ON_UNDEFINED_SYMBOLS=0 -sINVOKE_RUN=0 -sEXPORTED_FUNCTIONS=_main,_malloc,_free -sEXPORTED_RUNTIME_METHODS=FS,stringToUTF8,UTF8ToString --oformat=mjs" \
