...
[ "_main", "_malloc", "_free", "__Z14linkComponentsv", "__ZN4llvm3orc14linkComponentsEv", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "lli.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("lli.wasm", import.meta.url).href;
}
...
var __ZN4llvm3orc14linkComponentsEv = Module["__ZN4llvm3orc14linkComponentsEv"] = createExportWrapper("_ZN4llvm3orc14linkComponentsEv");
