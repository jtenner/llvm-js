...
[ "_main", "_malloc", "_free", "_llvm_jitlink_setTestResultOverride", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "llvm-jitlink.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("llvm-jitlink.wasm", import.meta.url).href;
}
...
var _llvm_jitlink_setTestResultOverride = Module["_llvm_jitlink_setTestResultOverride"] = createExportWrapper("llvm_jitlink_setTestResultOverride");
