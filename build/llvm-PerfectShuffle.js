...
if (Module["locateFile"]) {
 wasmBinaryFile = "llvm-PerfectShuffle.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("llvm-PerfectShuffle.wasm", import.meta.url).href;
}
