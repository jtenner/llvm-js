...
if (Module["locateFile"]) {
 wasmBinaryFile = "llvm-objdump.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("llvm-objdump.wasm", import.meta.url).href;
}
...
var dynCall_iijjjjii = Module["dynCall_iijjjjii"] = createExportWrapper("dynCall_iijjjjii");
...
var dynCall_iiiijjijjj = Module["dynCall_iiiijjijjj"] = createExportWrapper("dynCall_iiiijjijjj");
