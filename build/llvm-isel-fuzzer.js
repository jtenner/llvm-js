...
[ "_main", "_malloc", "_free", "_LLVMFuzzerInitialize", "_LLVMFuzzerCustomMutator", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "llvm-isel-fuzzer.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("llvm-isel-fuzzer.wasm", import.meta.url).href;
}
...
var _LLVMFuzzerInitialize = Module["_LLVMFuzzerInitialize"] = createExportWrapper("LLVMFuzzerInitialize");

var _free = Module["_free"] = createExportWrapper("free");

var _LLVMFuzzerCustomMutator = Module["_LLVMFuzzerCustomMutator"] = createExportWrapper("LLVMFuzzerCustomMutator");
