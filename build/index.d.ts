...
export declare enum LLVMCodeGenFileType {
    LLVMAssemblyFile = 0,
    LLVMObjectFile = 1
}
export declare enum LLVMCodeModel {
...
export declare enum LLVMCodeGenOptLevel {
    LLVMCodeGenLevelNone = 0,
    LLVMCodeGenLevelLess = 1,
    LLVMCodeGenLevelDefault = 2,
    LLVMCodeGenLevelAggressive = 3
}
export declare enum LLVMRelocMode {
    LLVMRelocDefault = 0,
    LLVMRelocStatic = 1,
    LLVMRelocPIC = 2,
...
export type LLVMPassBuilderOptionsRef = Pointer<"LLVMPassBuilderOptionsRef">;
export type LLVMPassManagerBuilderRef = Pointer<"LLVMPassManagerBuilderRef">;
export interface Module {
    ...
    _LLVMAddAddDiscriminatorsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddAggressiveDCEPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddAlignmentFromAssumptionsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddAlwaysInlinerPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddBasicAliasAnalysisPass(PM: LLVMPassManagerRef): void;
    _LLVMAddBitTrackingDCEPass(PM: LLVMPassManagerRef): void;
    _LLVMAddCFGSimplificationPass(PM: LLVMPassManagerRef): void;
    _LLVMAddCallSiteAttribute(Context: LLVMValueRef, Idx: LLVMAttributeIndex, A: LLVMAttributeRef): void;
    _LLVMAddCalledValuePropagationPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddConstantMergePass(PM: LLVMPassManagerRef): void;
    _LLVMAddCorrelatedValuePropagationPass(PM: LLVMPassManagerRef): void;
    _LLVMAddDCEPass(PM: LLVMPassManagerRef): void;
    _LLVMAddDeadArgEliminationPass(PM: LLVMPassManagerRef): void;
    _LLVMAddDeadStoreEliminationPass(PM: LLVMPassManagerRef): void;
    _LLVMAddDemoteMemoryToRegisterPass(PM: LLVMPassManagerRef): void;
    _LLVMAddDestination(IndirectBr: LLVMValueRef, Dest: LLVMBasicBlockRef): void;
    _LLVMAddEarlyCSEMemSSAPass(PM: LLVMPassManagerRef): void;
    _LLVMAddEarlyCSEPass(PM: LLVMPassManagerRef): void;
    _LLVMAddFunction(Module: LLVMModuleRef, Name: LLVMStringRef, FunctionTy: LLVMTypeRef): LLVMValueRef;
    _LLVMAddFunctionAttrsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddFunctionInliningPass(PM: LLVMPassManagerRef): void;
    _LLVMAddGVNPass(PM: LLVMPassManagerRef): void;
    _LLVMAddGlobal(Module: LLVMModuleRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
    _LLVMAddGlobalDCEPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddGlobalOptimizerPass(PM: LLVMPassManagerRef): void;
    _LLVMAddHandler(CatchSwitch: LLVMValueRef, Dest: LLVMBasicBlockRef): void;
    _LLVMAddIPSCCPPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddIndVarSimplifyPass(PM: LLVMPassManagerRef): void;
    _LLVMAddInstructionCombiningPass(PM: LLVMPassManagerRef): void;
    _LLVMAddInstructionCombiningPass(PM: LLVMPassManagerRef): void;
    _LLVMAddInstructionSimplifyPass(PM: LLVMPassManagerRef): void;
    _LLVMAddInternalizePass(Builder: LLVMPassManagerRef, AllButMain: number): void;
    _LLVMAddInternalizePassWithMustPreservePredicate(PM: LLVMPassManagerRef, Context: Pointer<any>, MustPreserve: LLVMBool): void;
    _LLVMAddJumpThreadingPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLICMPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopDeletionPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopIdiomPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopRerollPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopRotatePass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopUnrollAndJamPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopUnrollPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLoopVectorizePass(PM: LLVMPassManagerRef): void;
    _LLVMAddLowerAtomicPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLowerConstantIntrinsicsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLowerExpectIntrinsicPass(PM: LLVMPassManagerRef): void;
    _LLVMAddLowerSwitchPass(PM: LLVMPassManagerRef): void;
    _LLVMAddMemCpyOptPass(PM: LLVMPassManagerRef): void;
    _LLVMAddMergeFunctionsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddMergedLoadStoreMotionPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddNewGVNPass(PM: LLVMPassManagerRef): void;
    _LLVMAddPartiallyInlineLibCallsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddPromoteMemoryToRegisterPass(PM: LLVMPassManagerRef): void;
    _LLVMAddReassociatePass(PM: LLVMPassManagerRef): void;
    _LLVMAddSCCPPass(PM: LLVMPassManagerRef): void;
    _LLVMAddSLPVectorizePass(PM: LLVMPassManagerRef): void;
    _LLVMAddScalarReplAggregatesPass(PM: LLVMPassManagerRef): void;
    _LLVMAddScalarReplAggregatesPassSSA(PM: LLVMPassManagerRef): void;
    _LLVMAddScalarReplAggregatesPassWithThreshold(PM: LLVMPassManagerRef, Threshold: number): void;
    _LLVMAddScalarizerPass(PM: LLVMPassManagerRef): void;
    _LLVMAddScopedNoAliasAAPass(PM: LLVMPassManagerRef): void;
    _LLVMAddSimplifyLibCallsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddStripDeadPrototypesPass(PM: LLVMPassManagerRef): void;
    _LLVMAddStripSymbolsPass(PM: LLVMPassManagerRef): void;
    _LLVMAddSymbol(symbolName: LLVMStringRef, symbolValue: Pointer<any>): void;
    _LLVMAddTailCallEliminationPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMAddTypeBasedAliasAnalysisPass(PM: LLVMPassManagerRef): void;
    _LLVMAddUnifyFunctionExitNodesPass(PM: LLVMPassManagerRef): void;
    _LLVMAddVerifierPass(PM: LLVMPassManagerRef): void;
    ...
    _LLVMCreatePassBuilderOptions(): LLVMPassBuilderOptionsRef;
    ...
    _LLVMDisposePassBuilderOptions(Options: LLVMPassBuilderOptionsRef): void;
    ...
    _LLVMPassBuilderOptionsSetCallGraphProfile(Options: LLVMPassBuilderOptionsRef, CallGraphProfile: LLVMBool): void;
    _LLVMPassBuilderOptionsSetDebugLogging(Options: LLVMPassBuilderOptionsRef, DebugLogging: LLVMBool): void;
    _LLVMPassBuilderOptionsSetForgetAllSCEVInLoopUnroll(Options: LLVMPassBuilderOptionsRef, ForgetAllSCEVInLoopUnroll: LLVMBool): void;
    _LLVMPassBuilderOptionsSetLicmMssaNoAccForPromotionCap(Options: LLVMPassBuilderOptionsRef, LicmMssaNoAccForPromotionCap: number): void;
    _LLVMPassBuilderOptionsSetLicmMssaOptCap(Options: LLVMPassBuilderOptionsRef, LicmMssaOptCap: number): void;
    _LLVMPassBuilderOptionsSetLoopInterleaving(Options: LLVMPassBuilderOptionsRef, LoopInterleaving: LLVMBool): void;
    _LLVMPassBuilderOptionsSetLoopUnrolling(Options: LLVMPassBuilderOptionsRef, LoopUnrolling: LLVMBool): void;
    _LLVMPassBuilderOptionsSetLoopVectorization(Options: LLVMPassBuilderOptionsRef, LoopVectorization: LLVMBool): void;
    _LLVMPassBuilderOptionsSetMergeFunctions(Options: LLVMPassBuilderOptionsRef, MergeFunctions: LLVMBool): void;
    _LLVMPassBuilderOptionsSetSLPVectorization(Options: LLVMPassBuilderOptionsRef, SLPVectorization: LLVMBool): void;
    _LLVMPassBuilderOptionsSetVerifyEach(Options: LLVMPassBuilderOptionsRef, VerifyEach: LLVMBool): void;
    _LLVMPassManagerBuilderCreate(): LLVMPassManagerBuilderRef;
    _LLVMPassManagerBuilderDispose(PMB: LLVMPassManagerBuilderRef): void;
    _LLVMPassManagerBuilderPopulateFunctionPassManager(PMB: LLVMPassManagerBuilderRef, PM: LLVMPassManagerRef): void;
    _LLVMPassManagerBuilderPopulateModulePassManager(PMB: LLVMPassManagerBuilderRef, PM: LLVMPassManagerRef): void;
    _LLVMPassManagerBuilderSetDisableSimplifyLibCalls(PMB: LLVMPassManagerBuilderRef, Value: LLVMBool): void;
    _LLVMPassManagerBuilderSetDisableUnitAtATime(PMB: LLVMPassManagerBuilderRef, Value: LLVMBool): void;
    _LLVMPassManagerBuilderSetDisableUnrollLoops(PMB: LLVMPassManagerBuilderRef, Value: LLVMBool): void;
    _LLVMPassManagerBuilderSetOptLevel(PMB: LLVMPassManagerBuilderRef, OptLevel: number): void;
    _LLVMPassManagerBuilderSetSizeLevel(PMB: LLVMPassManagerBuilderRef, SizeLevel: number): void;
    _LLVMPassManagerBuilderUseInlinerWithThreshold(PMB: LLVMPassManagerBuilderRef, Threshold: number): void;
    ...
    _LLVMRunPasses(Module: LLVMModuleRef, Passes: LLVMStringRef, TM: LLVMTargetMachineRef, Options: LLVMPassBuilderOptionsRef): LLVMErrorRef;
