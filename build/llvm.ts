...
export interface Module {
  ...
  _LLVMWriteBitcodeToFile(M: LLVMModuleRef, Path: LLVMStringRef): number;
  _LLVMWriteBitcodeToFD(M: LLVMModuleRef, FD: number, ShouldClose: number, Unbuffered: number): number;
  _LLVMWriteBitcodeToFileHandle(M: LLVMModuleRef, Handle: number): number;
  ...
  _LLVMContextGetDiagnosticContext(C: LLVMContextRef): Pointer<any>;
  ...
  _LLVMGetMDKindIDInContext(C: LLVMContextRef, Name: LLVMStringRef, SLen: number): number;
  ...
  _LLVMGetModuleIdentifier(M: LLVMModuleRef, Len: Pointer<number>): LLVMStringRef;
  _LLVMSetModuleIdentifier(M: LLVMModuleRef, Ident: LLVMStringRef, Len: number): void;
  _LLVMGetSourceFileName(M: LLVMModuleRef, Len: Pointer<number>): LLVMStringRef;
  _LLVMSetSourceFileName(M: LLVMModuleRef, Name: LLVMStringRef, Len: number): void;
  _LLVMGetDataLayoutStr(M: LLVMModuleRef): LLVMStringRef;
  _LLVMGetDataLayout(M: LLVMModuleRef): LLVMStringRef;
  _LLVMSetDataLayout(M: LLVMModuleRef, DataLayoutStr: LLVMStringRef): void;
  _LLVMGetTarget(M: LLVMModuleRef): LLVMStringRef;
  _LLVMSetTarget(M: LLVMModuleRef, Triple: LLVMStringRef): void;
  _LLVMCopyModuleFlagsMetadata(M: LLVMModuleRef, Len: Pointer<number>): LLVMModuleFlagEntry;
  ...
  _LLVMModuleFlagEntriesGetKey(Entries: LLVMModuleFlagEntry, Index: number, Len: Pointer<number>): LLVMStringRef;
  ...
  _LLVMPrintModuleToString(M: LLVMModuleRef): LLVMStringRef;
  _LLVMGetModuleInlineAsm(M: LLVMModuleRef, Len: Pointer<number>): LLVMStringRef;
  ...
  _LLVMGetNamedMetadataNumOperands(M: LLVMModuleRef, Name: LLVMStringRef): number;
  ...
  _LLVMGetArrayLength2(ArrayTy: LLVMTypeRef): number;
  ...
  _LLVMTargetExtTypeInContext(C: LLVMContextRef, Name: LLVMStringRef, TypeParams: LLVMTypeRef, TypeParamCount: number, IntParams: Pointer<number>, IntParamCount: number): LLVMTypeRef;
  ...
  _LLVMConstRealGetDouble(ConstantVal: LLVMValueRef, losesInfo: LLVMBool): number;
  ...
  _LLVMGlobalCopyAllMetadata(Value: LLVMValueRef, NumEntries: Pointer<number>): LLVMValueMetadataEntry;
  _LLVMDisposeValueMetadataEntries(Entries: LLVMValueMetadataEntry): void;
  _LLVMValueMetadataEntriesGetKind(Entries: LLVMValueMetadataEntry, Index: number): number;
  ...
  _LLVMIntrinsicCopyOverloadedName(ID: number, ParamTypes: LLVMTypeRef, ParamCount: number, NameLength: Pointer<number>): LLVMStringRef;
  _LLVMIntrinsicCopyOverloadedName2(Mod: LLVMModuleRef, ID: number, ParamTypes: LLVMTypeRef, ParamCount: number, NameLength: Pointer<number>): LLVMStringRef;
  ...
  _LLVMInstructionGetAllMetadataOtherThanDebugLoc(Instr: LLVMValueRef, NumEntries: Pointer<number>): LLVMValueMetadataEntry;
  ...
  _LLVMGetCallSiteAttributeCount(C: LLVMValueRef, Idx: LLVMAttributeIndex): number;
  ...
  _LLVMBuildRetVoid(x0: LLVMBuilderRef): LLVMValueRef;
  _LLVMBuildRet(x0: LLVMBuilderRef, V: LLVMValueRef): LLVMValueRef;
  _LLVMBuildAggregateRet(x0: LLVMBuilderRef, RetVals: LLVMValueRef, N: number): LLVMValueRef;
  _LLVMBuildBr(x0: LLVMBuilderRef, Dest: LLVMBasicBlockRef): LLVMValueRef;
  _LLVMBuildCondBr(x0: LLVMBuilderRef, If: LLVMValueRef, Then: LLVMBasicBlockRef, Else: LLVMBasicBlockRef): LLVMValueRef;
  _LLVMBuildSwitch(x0: LLVMBuilderRef, V: LLVMValueRef, Else: LLVMBasicBlockRef, NumCases: number): LLVMValueRef;
  _LLVMBuildIndirectBr(B: LLVMBuilderRef, Addr: LLVMValueRef, NumDests: number): LLVMValueRef;
  _LLVMBuildInvoke2(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Then: LLVMBasicBlockRef, Catch: LLVMBasicBlockRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildUnreachable(x0: LLVMBuilderRef): LLVMValueRef;
  ...
  _LLVMBuildAdd(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWAdd(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWAdd(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFAdd(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSub(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWSub(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWSub(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFSub(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildMul(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWMul(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWMul(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFMul(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildUDiv(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExactUDiv(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSDiv(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExactSDiv(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFDiv(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildURem(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSRem(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFRem(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildShl(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildLShr(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAShr(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAnd(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildOr(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildXor(x0: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildBinOp(B: LLVMBuilderRef, Op: LLVMOpcode, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNeg(x0: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildFNeg(x0: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNot(x0: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildMalloc(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildArrayMalloc(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildAlloca(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildArrayAlloca(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFree(x0: LLVMBuilderRef, PointerVal: LLVMValueRef): LLVMValueRef;
  _LLVMBuildLoad2(x0: LLVMBuilderRef, Ty: LLVMTypeRef, PointerVal: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildStore(x0: LLVMBuilderRef, Val: LLVMValueRef, Ptr: LLVMValueRef): LLVMValueRef;
  ...
  _LLVMBuildTrunc(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildZExt(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSExt(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPToUI(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPToSI(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildUIToFP(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSIToFP(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPTrunc(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPExt(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPtrToInt(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntToPtr(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildBitCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAddrSpaceCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildZExtOrBitCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSExtOrBitCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildTruncOrBitCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCast(B: LLVMBuilderRef, Op: LLVMOpcode, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPointerCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntCast2(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, IsSigned: LLVMBool, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntCast(x0: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMGetCastOpcode(Src: LLVMValueRef, SrcIsSigned: LLVMBool, DestTy: LLVMTypeRef, DestIsSigned: LLVMBool): LLVMOpcode;
  _LLVMBuildICmp(x0: LLVMBuilderRef, Op: LLVMIntPredicate, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFCmp(x0: LLVMBuilderRef, Op: LLVMRealPredicate, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPhi(x0: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCall2(x0: LLVMBuilderRef, x1: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSelect(x0: LLVMBuilderRef, If: LLVMValueRef, Then: LLVMValueRef, Else: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildVAArg(x0: LLVMBuilderRef, List: LLVMValueRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExtractElement(x0: LLVMBuilderRef, VecVal: LLVMValueRef, Index: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInsertElement(x0: LLVMBuilderRef, VecVal: LLVMValueRef, EltVal: LLVMValueRef, Index: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildShuffleVector(x0: LLVMBuilderRef, V1: LLVMValueRef, V2: LLVMValueRef, Mask: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExtractValue(x0: LLVMBuilderRef, AggVal: LLVMValueRef, Index: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInsertValue(x0: LLVMBuilderRef, AggVal: LLVMValueRef, EltVal: LLVMValueRef, Index: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFreeze(x0: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIsNull(x0: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIsNotNull(x0: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPtrDiff2(x0: LLVMBuilderRef, ElemTy: LLVMTypeRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMGetDINodeTag(MD: LLVMMetadataRef): number;
  ...
  _LLVMRunFunctionAsMain(EE: LLVMExecutionEngineRef, F: LLVMValueRef, ArgC: number, ArgV: LLVMStringRef[], EnvP: LLVMStringRef[]): number;
  ...
  _LLVMParseCommandLineOptions(argc: number, argv: LLVMStringRef[], Overview: LLVMStringRef): void;
