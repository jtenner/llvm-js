...
export interface Module {
  ...
  _LLVMVerifyModule(Module: LLVMModuleRef, Action: LLVMVerifierFailureAction, OutMessage: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMCopyModuleFlagsMetadata(Module: LLVMModuleRef, Len: Pointer<number>): LLVMModuleFlagEntry;
  ...
  _LLVMPrintModuleToFile(Module: LLVMModuleRef, Filename: LLVMStringRef, ErrorMessage: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMGetNamedMetadataOperands(Module: LLVMModuleRef, Name: LLVMStringRef, Dest: LLVMValueRef): void;
  ...
  _LLVMStructTypeInContext(Context: LLVMContextRef, ElementTypes: LLVMTypeRef, ElementCount: number, Packed: LLVMBool): LLVMTypeRef;
  ...
  _LLVMTargetExtTypeInContext(Context: LLVMContextRef, Name: LLVMStringRef, TypeParams: LLVMTypeRef, TypeParamCount: number, IntParams: Pointer<number>, IntParamCount: number): LLVMTypeRef;
  ...
  _LLVMConstStructInContext(Context: LLVMContextRef, ConstantVals: LLVMValueRef, Count: number, Packed: LLVMBool): LLVMValueRef;
  ...
  _LLVMMDNodeInContext2(Context: LLVMContextRef, MDs: LLVMMetadataRef, Count: number): LLVMMetadataRef;
  ...
  _LLVMMDNodeInContext(Context: LLVMContextRef, Vals: LLVMValueRef, Count: number): LLVMValueRef;
  ...
  _LLVMGetCallSiteAttributes(Context: LLVMValueRef, Idx: LLVMAttributeIndex, Attrs: LLVMAttributeRef): void;
  ...
  _LLVMBuildAggregateRet(Builder: LLVMBuilderRef, RetVals: LLVMValueRef, N: number): LLVMValueRef;
  ...
  _LLVMBuildInvoke2(Builder: LLVMBuilderRef, Ty: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Then: LLVMBasicBlockRef, Catch: LLVMBasicBlockRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildCatchPad(Builder: LLVMBuilderRef, ParentPad: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCleanupPad(Builder: LLVMBuilderRef, ParentPad: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildGEP2(Builder: LLVMBuilderRef, Ty: LLVMTypeRef, Pointer: LLVMValueRef, Indices: LLVMValueRef, NumIndices: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInBoundsGEP2(Builder: LLVMBuilderRef, Ty: LLVMTypeRef, Pointer: LLVMValueRef, Indices: LLVMValueRef, NumIndices: number, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildCall2(Builder: LLVMBuilderRef, Type: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMDIBuilderCreateImportedModuleFromModule(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Module: LLVMMetadataRef, File: LLVMMetadataRef, Line: number, Elements: LLVMMetadataRef, NumElements: number): LLVMMetadataRef;
  ...
  _LLVMTargetMachineEmitToFile(T: LLVMTargetMachineRef, Module: LLVMModuleRef, Filename: LLVMStringRef, codegen: LLVMCodeGenFileType, ErrorMessage: LLVMStringRef[]): LLVMBool;
  _LLVMTargetMachineEmitToMemoryBuffer(T: LLVMTargetMachineRef, Module: LLVMModuleRef, codegen: LLVMCodeGenFileType, ErrorMessage: LLVMStringRef[], OutMemBuf: LLVMMemoryBufferRef): LLVMBool;
  ...
  _LLVMCreateExecutionEngineForModule(OutEE: LLVMExecutionEngineRef, Module: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMCreateInterpreterForModule(OutInterp: LLVMExecutionEngineRef, Module: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMCreateJITCompilerForModule(OutJIT: LLVMExecutionEngineRef, Module: LLVMModuleRef, OptLevel: number, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMInitializeMCJITCompilerOptions(Options: any, SizeOfOptions: number): void;
  _LLVMCreateMCJITCompilerForModule(OutJIT: LLVMExecutionEngineRef, Module: LLVMModuleRef, Options: any, SizeOfOptions: number, OutError: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMRemoveModule(EE: LLVMExecutionEngineRef, Module: LLVMModuleRef, OutMod: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
