...
export interface Module {
  ...
  _LLVMVerifyModule(M: LLVMModuleRef, Action: LLVMVerifierFailureAction, OutMessage: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMParseBitcode(MemBuf: LLVMMemoryBufferRef, OutModule: LLVMModuleRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMParseBitcode2(MemBuf: LLVMMemoryBufferRef, OutModule: LLVMModuleRef): LLVMBool;
  _LLVMParseBitcodeInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutModule: LLVMModuleRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMParseBitcodeInContext2(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutModule: LLVMModuleRef): LLVMBool;
  _LLVMGetBitcodeModuleInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: LLVMModuleRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMGetBitcodeModuleInContext2(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: LLVMModuleRef): LLVMBool;
  _LLVMGetBitcodeModule(MemBuf: LLVMMemoryBufferRef, OutM: LLVMModuleRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMGetBitcodeModule2(MemBuf: LLVMMemoryBufferRef, OutM: LLVMModuleRef): LLVMBool;
  _LLVMWriteBitcodeToFile(M: LLVMModuleRef, Path: LLVMStringRef): int;
  ...
  _LLVMGetOrInsertComdat(M: LLVMModuleRef, Name: LLVMStringRef): LLVMComdatRef;
  ...
  _LLVMCreateMessage(Message: LLVMStringRef): char;
  _LLVMDisposeMessage(Message: LLVMStringRef): void;
  _LLVMContextCreate(): LLVMContextRef;
  _LLVMGetGlobalContext(): LLVMContextRef;
  _LLVMContextSetDiagnosticHandler(C: LLVMContextRef, Handler: LLVMDiagnosticHandler, DiagnosticContext: Pointer<any>): void;
  ...
  _LLVMContextSetYieldCallback(C: LLVMContextRef, Callback: LLVMYieldCallback, OpaqueHandle: Pointer<any>): void;
  ...
  _LLVMGetMDKindIDInContext(C: LLVMContextRef, Name: LLVMStringRef, SLen: number): unsigned;
  _LLVMGetMDKindID(Name: LLVMStringRef, SLen: number): unsigned;
  _LLVMGetEnumAttributeKindForName(Name: LLVMStringRef, SLen: number): unsigned;
  ...
  _LLVMCreateStringAttribute(C: LLVMContextRef, K: LLVMStringRef, KLength: number, V: LLVMStringRef, VLength: number): LLVMAttributeRef;
  ...
  _LLVMGetTypeByName2(C: LLVMContextRef, Name: LLVMStringRef): LLVMTypeRef;
  _LLVMModuleCreateWithName(ModuleID: LLVMStringRef): LLVMModuleRef;
  _LLVMModuleCreateWithNameInContext(ModuleID: LLVMStringRef, C: LLVMContextRef): LLVMModuleRef;
  ...
  _LLVMSetModuleIdentifier(M: LLVMModuleRef, Ident: LLVMStringRef, Len: number): void;
  _LLVMGetSourceFileName(M: LLVMModuleRef, Len: any): const;
  _LLVMSetSourceFileName(M: LLVMModuleRef, Name: LLVMStringRef, Len: number): void;
  _LLVMGetDataLayoutStr(M: LLVMModuleRef): const;
  _LLVMGetDataLayout(M: LLVMModuleRef): const;
  _LLVMSetDataLayout(M: LLVMModuleRef, DataLayoutStr: LLVMStringRef): void;
  _LLVMGetTarget(M: LLVMModuleRef): const;
  _LLVMSetTarget(M: LLVMModuleRef, Triple: LLVMStringRef): void;
  ...
  _LLVMGetModuleFlag(M: LLVMModuleRef, Key: LLVMStringRef, KeyLen: number): LLVMMetadataRef;
  _LLVMAddModuleFlag(M: LLVMModuleRef, Behavior: LLVMModuleFlagBehavior, Key: LLVMStringRef, KeyLen: number, Val: LLVMMetadataRef): void;
  _LLVMDumpModule(M: LLVMModuleRef): void;
  _LLVMPrintModuleToFile(M: LLVMModuleRef, Filename: LLVMStringRef, ErrorMessage: LLVMStringRef[]): LLVMBool;
  _LLVMPrintModuleToString(M: LLVMModuleRef): char;
  _LLVMGetModuleInlineAsm(M: LLVMModuleRef, Len: any): const;
  _LLVMSetModuleInlineAsm2(M: LLVMModuleRef, Asm: LLVMStringRef, Len: number): void;
  _LLVMAppendModuleInlineAsm(M: LLVMModuleRef, Asm: LLVMStringRef, Len: number): void;
  ...
  _LLVMGetTypeByName(M: LLVMModuleRef, Name: LLVMStringRef): LLVMTypeRef;
  ...
  _LLVMGetNamedMetadata(M: LLVMModuleRef, Name: LLVMStringRef, NameLen: number): LLVMNamedMDNodeRef;
  _LLVMGetOrInsertNamedMetadata(M: LLVMModuleRef, Name: LLVMStringRef, NameLen: number): LLVMNamedMDNodeRef;
  _LLVMGetNamedMetadataName(NamedMD: LLVMNamedMDNodeRef, NameLen: any): const;
  _LLVMGetNamedMetadataNumOperands(M: LLVMModuleRef, Name: LLVMStringRef): unsigned;
  _LLVMGetNamedMetadataOperands(M: LLVMModuleRef, Name: LLVMStringRef, Dest: LLVMValueRef): void;
  _LLVMAddNamedMetadataOperand(M: LLVMModuleRef, Name: LLVMStringRef, Val: LLVMValueRef): void;
  ...
  _LLVMAddFunction(M: LLVMModuleRef, Name: LLVMStringRef, FunctionTy: LLVMTypeRef): LLVMValueRef;
  _LLVMGetNamedFunction(M: LLVMModuleRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMSetModuleInlineAsm(M: LLVMModuleRef, Asm: LLVMStringRef): void;
  ...
  _LLVMStructCreateNamed(C: LLVMContextRef, Name: LLVMStringRef): LLVMTypeRef;
  ...
  _LLVMTargetExtTypeInContext(C: LLVMContextRef, Name: LLVMStringRef, TypeParams: LLVMTypeRef, TypeParamCount: number, IntParams: any, IntParamCount: number): LLVMTypeRef;
  ...
  _LLVMConstStringInContext(C: LLVMContextRef, Str: LLVMStringRef, Length: number, DontNullTerminate: LLVMBool): LLVMValueRef;
  ...
  _LLVMAddGlobal(M: LLVMModuleRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMAddGlobalInAddressSpace(M: LLVMModuleRef, Ty: LLVMTypeRef, Name: LLVMStringRef, AddressSpace: number): LLVMValueRef;
  _LLVMGetNamedGlobal(M: LLVMModuleRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMAddAlias2(M: LLVMModuleRef, ValueTy: LLVMTypeRef, AddrSpace: number, Aliasee: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMGetNamedGlobalAlias(M: LLVMModuleRef, Name: LLVMStringRef, NameLen: number): LLVMValueRef;
  ...
  _LLVMLookupIntrinsicID(Name: LLVMStringRef, NameLen: number): unsigned;
  ...
  _LLVMAddGlobalIFunc(M: LLVMModuleRef, Name: LLVMStringRef, NameLen: number, Ty: LLVMTypeRef, AddrSpace: number, Resolver: LLVMValueRef): LLVMValueRef;
  _LLVMGetNamedGlobalIFunc(M: LLVMModuleRef, Name: LLVMStringRef, NameLen: number): LLVMValueRef;
  ...
  _LLVMMDStringInContext2(C: LLVMContextRef, Str: LLVMStringRef, SLen: number): LLVMMetadataRef;
  ...
  _LLVMMDStringInContext(C: LLVMContextRef, Str: LLVMStringRef, SLen: number): LLVMValueRef;
  ...
  _LLVMCreateBasicBlockInContext(C: LLVMContextRef, Name: LLVMStringRef): LLVMBasicBlockRef;
  _LLVMAppendBasicBlockInContext(C: LLVMContextRef, Fn: LLVMValueRef, Name: LLVMStringRef): LLVMBasicBlockRef;
  _LLVMAppendBasicBlock(Fn: LLVMValueRef, Name: LLVMStringRef): LLVMBasicBlockRef;
  _LLVMInsertBasicBlockInContext(C: LLVMContextRef, BB: LLVMBasicBlockRef, Name: LLVMStringRef): LLVMBasicBlockRef;
  ...
  _LLVMGetCallSiteStringAttribute(C: LLVMValueRef, Idx: LLVMAttributeIndex, K: LLVMStringRef, KLen: number): LLVMAttributeRef;
  _LLVMRemoveCallSiteEnumAttribute(C: LLVMValueRef, Idx: LLVMAttributeIndex, KindID: number): void;
  _LLVMRemoveCallSiteStringAttribute(C: LLVMValueRef, Idx: LLVMAttributeIndex, K: LLVMStringRef, KLen: number): void;
  ...
  _LLVMBuildInvoke2(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Then: LLVMBasicBlockRef, Catch: LLVMBasicBlockRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildLandingPad(B: LLVMBuilderRef, Ty: LLVMTypeRef, PersFn: LLVMValueRef, NumClauses: number, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildCatchPad(B: LLVMBuilderRef, ParentPad: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCleanupPad(B: LLVMBuilderRef, ParentPad: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCatchSwitch(B: LLVMBuilderRef, ParentPad: LLVMValueRef, UnwindBB: LLVMBasicBlockRef, NumHandlers: number, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildAdd(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWAdd(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWAdd(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFAdd(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSub(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWSub(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWSub(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFSub(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildMul(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWMul(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWMul(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFMul(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildUDiv(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExactUDiv(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSDiv(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExactSDiv(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFDiv(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildURem(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSRem(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFRem(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildShl(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildLShr(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAShr(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAnd(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildOr(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildXor(undefined: LLVMBuilderRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildBinOp(B: LLVMBuilderRef, Op: LLVMOpcode, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNeg(undefined: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNSWNeg(B: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNUWNeg(B: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFNeg(undefined: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildNot(undefined: LLVMBuilderRef, V: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildMalloc(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildArrayMalloc(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildAlloca(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildArrayAlloca(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFree(undefined: LLVMBuilderRef, PointerVal: LLVMValueRef): LLVMValueRef;
  _LLVMBuildLoad2(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, PointerVal: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildStore(undefined: LLVMBuilderRef, Val: LLVMValueRef, Ptr: LLVMValueRef): LLVMValueRef;
  _LLVMBuildGEP2(B: LLVMBuilderRef, Ty: LLVMTypeRef, Pointer: LLVMValueRef, Indices: LLVMValueRef, NumIndices: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInBoundsGEP2(B: LLVMBuilderRef, Ty: LLVMTypeRef, Pointer: LLVMValueRef, Indices: LLVMValueRef, NumIndices: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildStructGEP2(B: LLVMBuilderRef, Ty: LLVMTypeRef, Pointer: LLVMValueRef, Idx: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildGlobalString(B: LLVMBuilderRef, Str: LLVMStringRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildGlobalStringPtr(B: LLVMBuilderRef, Str: LLVMStringRef, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMBuildTrunc(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildZExt(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSExt(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPToUI(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPToSI(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildUIToFP(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSIToFP(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPTrunc(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPExt(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPtrToInt(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntToPtr(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildBitCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildAddrSpaceCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildZExtOrBitCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSExtOrBitCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildTruncOrBitCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCast(B: LLVMBuilderRef, Op: LLVMOpcode, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPointerCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntCast2(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, IsSigned: LLVMBool, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFPCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIntCast(undefined: LLVMBuilderRef, Val: LLVMValueRef, DestTy: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMGetCastOpcode(Src: LLVMValueRef, SrcIsSigned: LLVMBool, DestTy: LLVMTypeRef, DestIsSigned: LLVMBool): LLVMOpcode;
  _LLVMBuildICmp(undefined: LLVMBuilderRef, Op: LLVMIntPredicate, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFCmp(undefined: LLVMBuilderRef, Op: LLVMRealPredicate, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPhi(undefined: LLVMBuilderRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildCall2(undefined: LLVMBuilderRef, undefined: LLVMTypeRef, Fn: LLVMValueRef, Args: LLVMValueRef, NumArgs: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildSelect(undefined: LLVMBuilderRef, If: LLVMValueRef, Then: LLVMValueRef, Else: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildVAArg(undefined: LLVMBuilderRef, List: LLVMValueRef, Ty: LLVMTypeRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExtractElement(undefined: LLVMBuilderRef, VecVal: LLVMValueRef, Index: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInsertElement(undefined: LLVMBuilderRef, VecVal: LLVMValueRef, EltVal: LLVMValueRef, Index: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildShuffleVector(undefined: LLVMBuilderRef, V1: LLVMValueRef, V2: LLVMValueRef, Mask: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildExtractValue(undefined: LLVMBuilderRef, AggVal: LLVMValueRef, Index: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildInsertValue(undefined: LLVMBuilderRef, AggVal: LLVMValueRef, EltVal: LLVMValueRef, Index: number, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFreeze(undefined: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIsNull(undefined: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildIsNotNull(undefined: LLVMBuilderRef, Val: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildPtrDiff2(undefined: LLVMBuilderRef, ElemTy: LLVMTypeRef, LHS: LLVMValueRef, RHS: LLVMValueRef, Name: LLVMStringRef): LLVMValueRef;
  _LLVMBuildFence(B: LLVMBuilderRef, ordering: LLVMAtomicOrdering, singleThread: LLVMBool, Name: LLVMStringRef): LLVMValueRef;
  ...
  _LLVMCreateMemoryBufferWithContentsOfFile(Path: LLVMStringRef, OutMemBuf: LLVMMemoryBufferRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMCreateMemoryBufferWithSTDIN(OutMemBuf: LLVMMemoryBufferRef, OutMessage: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMDIBuilderCreateImportedDeclaration(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Decl: LLVMMetadataRef, File: LLVMMetadataRef, Line: number, Name: LLVMStringRef, NameLen: number, Elements: LLVMMetadataRef, NumElements: number): LLVMMetadataRef;
  ...
  _LLVMDIBuilderCreateEnumerationType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: LLVMStringRef, NameLen: number, File: LLVMMetadataRef, LineNumber: number, SizeInBits: number, AlignInBits: number, Elements: LLVMMetadataRef, NumElements: number, ClassTy: LLVMMetadataRef): LLVMMetadataRef;
  _LLVMDIBuilderCreateUnionType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: LLVMStringRef, NameLen: number, File: LLVMMetadataRef, LineNumber: number, SizeInBits: number, AlignInBits: number, Flags: LLVMDIFlags, Elements: LLVMMetadataRef, NumElements: number, RunTimeLang: number, UniqueId: LLVMStringRef, UniqueIdLen: number): LLVMMetadataRef;
  ...
  _LLVMDisasmInstruction(DC: LLVMDisasmContextRef, Bytes: uint8_t, BytesSize: number, PC: number, OutString: LLVMStringRef, OutStringSize: number): size_t;
  ...
  _LLVMGetTargetFromTriple(Triple: LLVMStringRef, T: LLVMTargetRef, ErrorMessage: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMTargetMachineEmitToFile(T: LLVMTargetMachineRef, M: LLVMModuleRef, Filename: LLVMStringRef, codegen: LLVMCodeGenFileType, ErrorMessage: LLVMStringRef[]): LLVMBool;
  _LLVMTargetMachineEmitToMemoryBuffer(T: LLVMTargetMachineRef, M: LLVMModuleRef, codegen: LLVMCodeGenFileType, ErrorMessage: LLVMStringRef[], OutMemBuf: LLVMMemoryBufferRef): LLVMBool;
  _LLVMGetDefaultTargetTriple(): char;
  _LLVMNormalizeTargetTriple(triple: LLVMStringRef): char;
  ...
  _LLVMCreateExecutionEngineForModule(OutEE: LLVMExecutionEngineRef, M: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMCreateInterpreterForModule(OutInterp: LLVMExecutionEngineRef, M: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMCreateJITCompilerForModule(OutJIT: LLVMExecutionEngineRef, M: LLVMModuleRef, OptLevel: number, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMInitializeMCJITCompilerOptions(Options: any, SizeOfOptions: number): void;
  _LLVMCreateMCJITCompilerForModule(OutJIT: LLVMExecutionEngineRef, M: LLVMModuleRef, Options: any, SizeOfOptions: number, OutError: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMRemoveModule(EE: LLVMExecutionEngineRef, M: LLVMModuleRef, OutMod: LLVMModuleRef, OutError: LLVMStringRef[]): LLVMBool;
  _LLVMFindFunction(EE: LLVMExecutionEngineRef, Name: LLVMStringRef, OutFn: LLVMValueRef): LLVMBool;
  ...
  _LLVMGetGlobalValueAddress(EE: LLVMExecutionEngineRef, Name: LLVMStringRef): uint64_t;
  _LLVMGetFunctionAddress(EE: LLVMExecutionEngineRef, Name: LLVMStringRef): uint64_t;
  _LLVMExecutionEngineGetErrMsg(EE: LLVMExecutionEngineRef, OutError: LLVMStringRef[]): LLVMBool;
  ...
  _LLVMParseIRInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: LLVMModuleRef, OutMessage: LLVMStringRef[]): LLVMBool;
  _LLVMLinkModules2(Dest: LLVMModuleRef, Src: LLVMModuleRef): LLVMBool;
  _LLVMCreateBinary(MemBuf: LLVMMemoryBufferRef, Context: LLVMContextRef, ErrorMessage: LLVMStringRef[]): LLVMBinaryRef;
  ...
  _LLVMMachOUniversalBinaryCopyObjectForArch(BR: LLVMBinaryRef, Arch: LLVMStringRef, ArchLen: number, ErrorMessage: LLVMStringRef[]): LLVMBinaryRef;
  ...
  _LLVMParseCommandLineOptions(argc: number, argv: any, Overview: LLVMStringRef): void;
  _LLVMSearchForAddressOfSymbol(symbolName: LLVMStringRef): void;
