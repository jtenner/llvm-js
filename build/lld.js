...
if (Module["locateFile"]) {
 wasmBinaryFile = "lld.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("lld.wasm", import.meta.url).href;
}
...
var dynCall_iiiiijij = Module["dynCall_iiiiijij"] = createExportWrapper("dynCall_iiiiijij");
...
var dynCall_viiijjjjjj = Module["dynCall_viiijjjjjj"] = createExportWrapper("dynCall_viiijjjjjj");
