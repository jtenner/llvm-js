...
[ "_main", "_malloc", "_free", "__Z14linkComponentsv", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "llvm-jitlink-executor.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("llvm-jitlink-executor.wasm", import.meta.url).href;
}
...
var __Z14linkComponentsv = Module["__Z14linkComponentsv"] = createExportWrapper("_Z14linkComponentsv");
